namespace ServerControll
{
    ...
    public class ServerControll : BaseScript
    {
        ...
        internal static string string_17 = "^7NaaBAdmin v4.1 by ^5MH11^7 - Info: ^1WWW.NaaBClub.IR";
        internal static string string_18 = "kill";
        internal static string string_19 = "tempban";
        internal static string string_2 = "teknomw3";
        internal static string string_20 = "https://naabclub.ir";
                ...
                if (key != null)
                {
                    ...
                    if (Class74.dictionary_0.TryGetValue(key, out num))
                    {
                        ...
                        switch (num)
                        {
                            ...
                            case 0x70:
                            case 0x71:
                                Class75.smethod_73(this, class2.entity_0, "^7NaaBAdmin v4.1 by ^5Dargula^7 - Info: ^1WWW.NaaBClub.IR");
                                return;
