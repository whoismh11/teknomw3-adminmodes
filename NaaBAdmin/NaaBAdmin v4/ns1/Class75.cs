    ...
    internal sealed class Class75
    {
        ...
        /* private scope */internal static void smethod_100(Entity entity_0, ServerControll serverControll_0)
        {
            try
            {
                ...
                if (ServerControll.list_3.Contains(entity_0))
                {
                    ...
                    {
                        if (ServerControll.string_2.StartsWith("te") && ServerControll.dictionary_1.ContainsKey(serverControll_0.getPlayerHWID(entity_0)))
                        {
        ...
        /* private scope */internal static void smethod_106(string string_0, ServerControll serverControll_0, string string_1)
        {
            ...
            catch (Exception exception)
            {
                ...
                smethod_84("Error - Problem automatic updates, check for updates manually on the official page: http://www.btfitalianclan.com/", serverControll_0);
        ...
        /* private scope */internal static void smethod_109(ServerControll serverControll_0)
        {
            try
            {
                ...
                ServerControll.bool_13 = parser.GetBoolSetting(ServerControll.bool_13, "GRAFIC_SERVER", "EditListPalyer");
        ...
        /* private scope */internal static void smethod_11(ServerControll serverControll_0, Entity entity_0)
        {
            ...
            smethod_64(serverControll_0, "^1" + serverControll_0.getPlayerName(class2.entity_0) + " ^5blocked to camp, watch the minimap to find");
        ...
        /* private scope */internal static void smethod_121(Entity entity_0, Entity entity_1, ServerControll serverControll_0)
        {
            if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_56))
            {
                ...
                Label_0098:
                    flag2 = false;
                    flag = true;
                    smethod_73(serverControll_0, entity_0, "^5Alias eliminated player ^1" + serverControll_0.getPlayerName(entity_1));
                Label_00B5:
                    if (flag2)
                    {
        ...
        /* private scope */internal static void smethod_140(ServerControll serverControll_0)
        {
            if (ServerControll.bool_42)
            {
                ...
                ServerControll.hudElem_2.SetText(ServerControll.string_101 + " ^7\"" + smethod_88(serverControll_0, ServerControll.string_92) + "\"");
        ...
        /* private scope */internal static void smethod_141(Entity entity_0, ServerControll serverControll_0)
        {
            if (System.IO.File.Exists(ServerControll.string_88 + ServerControll.string_59))
            {
                ...
                Label_0077:
                    ...
                    smethod_73(serverControll_0, entity_0, "^1" + serverControll_0.getPlayerName(entity_0) + " ^5control auto enabled!");
                }
            }
        }
                    ...
                    if (entity_0.Call<Vector3>("getplayerangles", new Parameter[0]).Z == 0f)
                    {
                        if (entity_0.GetField<int>("NoRecoil") > 40)
                        {
                            if (serverControll_0.getPlayerPause(entity_0) == 0)
                            {
                                ...
                                {
                                    serverControll_0.method_23(null, entity_0, 5, "^1TempBan ^515min^1 for suspicion use No-Recoil!");
                                }
                                else
                                {
        ...
        /* private scope */internal static void smethod_144(Entity entity_0, ServerControll serverControll_0, Entity entity_1)
        {
            ...
            if (System.IO.File.Exists(ServerControll.string_99))
            {
                ...
                else
                {
                    ...
                    if (entity_1 != null)
                    {
                        smethod_73(serverControll_0, entity_1, "^1" + class2.string_1 + " ^5connect from ^7[^1" + class2.string_0 + "^7]");
                    }
        ...
        /* private scope */internal static void smethod_148(ServerControll serverControll_0)
        {
            if (System.IO.File.Exists(ServerControll.string_84 + ServerControll.string_49))
            {
                ...
                if (strArray.Length != 0)
                {
                    ...
                    {
                        smethod_64(serverControll_0, string.Concat(new object[] { "^7It's ^5", DateTime.Now.ToShortTimeString(), "^7 o'clock of ^1", DateTime.Now.Day, "^7/^1", DateTime.Now.Month, "^7/^1", DateTime.Now.Year }));
                    }
                    else if (strArray[index].StartsWith("#report"))
                    {
                        smethod_64(serverControll_0, "^5Use ^1!report^5 to report a cheating player!!!");
                    }
        ...
        /* private scope */internal static void smethod_149(Entity entity_0, Entity entity_1)
        {
            ...
            entity_0.Call("iprintlnbold", new Parameter[] { "^1You teleport from " + entity_1.Name });
        }
        ...
        /* private scope */internal static void smethod_150(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            int delay = 200;
            class2.string_0 = "^1" + ServerControll.string_19 + " for suspicion use AIMBOT!!!";
                ...
                else
                {
                    ...
                    if (System.IO.File.Exists(ServerControll.string_71))
                    {
                        ...
                        else if (str != class3.string_1)
                        {
                            if (entity_0 != null)
                            {
                                smethod_73(serverControll_0, entity_0, "^5Available to download the new version ^1NaaBAdmin " + class3.string_1 + " ^5Link:^1 " + class3.string_0);
                            }
                            else
                            {
                                if (func == null)
        ...
        /* private scope */internal static void smethod_159(ServerControll serverControll_0)
        {
            ...
            if (!System.IO.File.Exists(ServerControll.string_84 + ServerControll.string_49))
            {
                using (writer = new StreamWriter(ServerControll.string_84 + ServerControll.string_49, true))
                {
                    ...
                    writer.WriteLine("^7WebSite: ^5www.naabbax.ir");
                    writer.WriteLine("#nextmap");
                    writer.WriteLine("^7TeamSpeak: ^5ts.naabbax.ir");
                    writer.WriteLine("#report");
                    writer.WriteLine("^7Telegram: ^5NaaB_Bax");
                    writer.Close();
                }
            }
            if (!System.IO.File.Exists(ServerControll.string_84 + ServerControll.string_48))
            {
                ...
                {
                    writer.WriteLine("^1Rule 1: ^7No racism of any kind");
                    writer.WriteLine("^1Rule 2: ^7No clan stacking, members must split evenly between the teams");
                    writer.WriteLine("^1Rule 3: ^7No arguing with admins (listen and learn or leave)");
                    writer.WriteLine("^1Rule 4: ^7No abusive language or behavior towards admins or other players");
                    writer.WriteLine("^1Rule 5: ^7No offensive or potentially offensive names, annoying names, or in-game (double caret (^)) color in names");
                    writer.WriteLine("^1Rule 6: ^7No recruiting for your clan, your server, or anything else");
                    writer.WriteLine("^1Rule 7: ^7No advertising or spamming of websites or servers");
                    writer.WriteLine("^1Rule 8: ^7No profanity or offensive language (in any language)");
                    writer.WriteLine("^1Rule 9: ^7Do ^1NOT ^7fire at teammates or within 10 seconds of spawning");
                    writer.WriteLine("^1Rule 10: ^7Offense players must play for the objective and support their team");
                    writer.WriteLine("^1Rule 11: ^7Not use ^1CHEAT^7 or ^1HACK^7, you will be ^1BANNED!!!");
                    writer.Close();
                }
            }
        ...
        /* private scope */internal static void smethod_160(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            {
                smethod_10(serverControll_0, serverControll_0.getPlayerName(entity_0) + " ^5joined on^1 " + str2);
            }
        }
            ...
            else
            {
                ...
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_55))
                {
                    ...
                    for (int i = 0; i < strArray.Length; i++)
                    {
                        ...
                        {
                            class3.string_0 = string.Concat(new object[] { "^1Ban ^7ID[^5", i, "^7] for^1 ", strArray2[index] });
                        }
                        else
                        {
                            class3.string_0 = string.Concat(new object[] { "^1Ban ^7ID[^5", i, "^7] from the ^1", ServerControll.string_5, "^7 Server" });
                        }
                        if ((ServerControll.string_20 != "null") && (ServerControll.string_20 != null))
                        {
                            class3.string_0 = class3.string_0 + "^1, Request Unban^5 " + ServerControll.string_20;
                        }
                        for (int j = 0; j < strArray2.Length; j++)
                        {
                            if (ServerControll.string_2.StartsWith("te"))
                            {
        ...
        /* private scope */internal static void smethod_164(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_54))
            {
                ...
                for (int i = 0; i < strArray.Length; i++)
                {
                    ...
                    if (!strArray2[index].Contains("."))
                    {
                        class3.string_0 = string.Concat(new object[] { "^1TempBan ^7ID[^5", i, "^7] for^1 ", strArray2[index] });
                    }
                    else
                    {
                        class3.string_0 = string.Concat(new object[] { "^1TempBan ^7ID[^5", i, "^7] from the ^1", ServerControll.string_5, "^7 Server" });
                    }
                    for (int j = 0; j < strArray2.Length; j++)
                    {
                ...
                Label_027E:
                    if (serverControll_0.TPassato(DateTime.Parse(strArray3[0])) < num4)
                    {
                        ...
                        class3.string_0 = string.Concat(new object[] { obj2, "^5 for other ^1", num5, "min" });
                        if ((ServerControll.string_20 != "null") && (ServerControll.string_20 != null))
                        {
                            class3.string_0 = class3.string_0 + "^1, Request Unban^5 " + ServerControll.string_20;
                        }
                ...
                Label_0350:
                    if (serverControll_0.TPassato(DateTime.Parse(strArray3[0])) < num4)
                    {
                        num5 = Convert.ToInt32((double) (num4 - serverControll_0.TPassato(DateTime.Parse(strArray3[0]))));
                        obj2 = class3.string_0;
                        class3.string_0 = string.Concat(new object[] { obj2, "^1 for other ^5", num5, "min" });
                        if ((ServerControll.string_20 != "null") && (ServerControll.string_20 != null))
                        {
                            class3.string_0 = class3.string_0 + "^1, Request Unban^5 " + ServerControll.string_20;
                        }
        ...
        /* private scope */internal static void smethod_167(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_51))
                {
                    ...
                    smethod_73(serverControll_0, class2.entity_0, "^5List^7[^1" + class3.string_0.Length + "^7]^5 Bad Words:");
        ...
        /* private scope */internal static void smethod_17(ServerControll serverControll_0, Entity entity_0, Entity entity_1)
        {
            if (entity_1.Health > 0)
            {
                ...
                {
                    smethod_73(serverControll_0, entity_0, "^1Invisible godmode enabled for: ^7" + entity_1.Name);
                }
            }
            else
            {
                ...
                if ((entity_0 != null) && (entity_0 != entity_1))
                {
                    smethod_73(serverControll_0, entity_0, "^1Invisible godmode disabled for: ^7" + entity_1.Name);
                }
            }
        }
        ...
        /* private scope */internal static void smethod_170(Entity entity_0, string string_0, ServerControll serverControll_0)
        {
            ...
            smethod_73(serverControll_0, entity_0, "^5NextMap set ^1" + smethod_88(serverControll_0, ServerControll.string_91));
        ...
        {
            int num;
            string[] strArray2 = new string[] { "ServerControll.txt" };
                ...
                else if (string_0.Equals("set afk"))
                {
                    if (smethod_161("!setafk", serverControll_0, entity_0))
                    {
                        if (!ServerControll.string_93.Contains("inf"))
                        {
                            ...
                            smethod_73(serverControll_0, entity_0, "^1" + entity_1.Name + " ^5set AFK");
                        }
                        else
                        {
                            smethod_73(serverControll_0, entity_0, "You can not set Afk in infect mode");
                        }
                    }
                    else
                    {
                    ...
                    if (smethod_161("!kill", serverControll_0, entity_0))
                    {
                        if (entity_1.IsAlive)
                        {
                            if (serverControll_0.getPlayerLevel(entity_1) <= serverControll_0.getPlayerLevel(entity_0))
                            {
                                ...
                                smethod_73(serverControll_0, entity_0, "^1" + serverControll_0.getPlayerName(entity_1) + " ^5killed!");
                            }
                            else
                            {
        ...
        /* private scope */internal static void smethod_180(ServerControll serverControll_0, Entity entity_0)
        {
            ...
            try
            {
                ...
                smethod_73(serverControll_0, class3.entity_0, "^5Player^7[^1" + ServerControll.list_3.Count + "^7] ^5List in Game:");
                class2.int_0 = 0;
            ...
            else
            {
                switch (int_0)
                {
                    case 0:
                        ...
                        //smethod_73(serverControll_0, entity_0, "FilmTweak set^1 " + int_0);
                        return;
                ...
                smethod_73(serverControll_0, entity_0, "FilmTweak not correct, use 0 - 13");
            }
        }
        ...
        /* private scope */internal static void smethod_190(Entity entity_0, Entity entity_1, ServerControll serverControll_0)
        {
            ...
            smethod_73(serverControll_0, entity_1, "^5Fire activeted for^1 " + entity_0.Name);
        }
        ...
        /* private scope */internal static void smethod_195(int int_0, string string_0, string string_1, ServerControll serverControll_0)
        {
            try
            {
                ...
                else if (strArray[0] == "!votemod")
                {
                    ...
                    {
                        smethod_158(serverControll_0, entity, "^1" + entity.Name + " Mode ^5" + strArray[1].ToUpper() + "^1 not found!");
                    }
                }
            }
            catch (Exception exception)
        ...
        /* private scope */internal static void smethod_201(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_54))
                {
                    ...
                    smethod_73(serverControll_0, class2.entity_0, "^5List^7[^1" + class3.string_0.Length + "^7] ^5Player TempBan:");
        ...
        /* private scope */internal static void smethod_202(ServerControll serverControll_0, Entity entity_0)
        {
            if (System.IO.File.Exists(ServerControll.string_85 + serverControll_0.FileUser))
            {
                ...
                Label_009A:
                    ...
                    smethod_73(serverControll_0, entity_0, "^5Player ^1" + strArray2[1] + "^7[^1" + strArray2[3] + "^7] ^5unregistered!");
                Label_0114:
                    if (flag2)
                    {
        ...
        /* private scope */internal static void smethod_205(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            {
                class2.hudElem_0.Call("settext", new Parameter[] { "^7NaaBAdmin v4.0 \"BetaTest\" by ^5MH11" });
            }
            else
            {
                class2.hudElem_0.Call("settext", new Parameter[] { "^7NaaBAdmin v4.0 by ^5MH11" });
            }
            class2.hudElem_0.Alpha = 0f;
        ...
        /* private scope */internal static void smethod_217(Entity entity_0, ServerControll serverControll_0)
        {
            if (entity_0.IsAlive)
            {
                if (entity_0.GetField<string>("sessionstate") != "spectator")
                {
                    ...
                    smethod_158(serverControll_0, entity_0, "^5" + serverControll_0.getPlayerName(entity_0) + " ^1Fly enabled!!!");
                }
                else
                {
                    ...
                    smethod_158(serverControll_0, entity_0, "^5" + serverControll_0.getPlayerName(entity_0) + " ^1Fly disabled!!!");
                }
            }
        }
            ...
            if (System.IO.File.Exists(ServerControll.string_85 + serverControll_0.FileUser))
            {
                ...
                for (int i = 0; i < strArray.Length; i++)
                {
                    ...
                    if (strArray2[0].Equals(ServerControll.GetMd5Hash(serverControll_0.md5Hash, string_0)) && ((((strArray2[1] == serverControll_0.getPlayerName(entity_0)) || (strArray2[2] == serverControll_0.getPlayerID(entity_0))) || (strArray2[3] == serverControll_0.getPlayerGuid(entity_0))) || (strArray2[4] == serverControll_0.getPlayerXuid(entity_0))))
                    {
                        ...
                        smethod_73(serverControll_0, entity_0, "^1" + serverControll_0.getPlayerName(entity_0) + " ^5password correct, welcome back!");
                        flag = true;
                ...
                if (!flag)
                {
                    ...
                    smethod_73(serverControll_0, entity_0, string.Concat(new object[] { "^5", serverControll_0.getPlayerName(entity_0), " ^1password NOT correct; Attempted: ^5", num2, "/3" }));
        ...
        /* private scope */internal static void smethod_227(ServerControll serverControll_0)
        {
            ...
            if (ServerControll.bool_29)
            {
                ...
                parser.SaveSettings();
                smethod_64(serverControll_0, "^5Explosive Bullets Disabled");
            }
            else
            {
                ...
                parser.SaveSettings();
                smethod_64(serverControll_0, "^1Explosive Bullets Enabled");
            }
        }
        ...
        Label_0370:
            ...
            if (bool_0)
            {
                if (entity_0 == null)
                {
                    smethod_64(serverControll_0, "^1NextMap^7: ^5" + str4);
                }
                else
                {
                    smethod_73(serverControll_0, entity_0, "^1NextMap^7: ^5" + str4);
                }
            }
        }
        ...
        */
            ...
            try
            {
                    ...
                    using (writer = new StreamWriter(ServerControll.string_84 + ServerControll.string_52, true))
                    {
                        for (num = 0; num < class3.string_0.Length; num++)
                        {
                            ...
                            if (strArray[1] == serverControll_0.getPlayerGuid(entity_0))
                            {
                                ...
                                if (num2 == 5)
                                {
                                    smethod_20(serverControll_0, "Server", "k", entity_0, "Kick - Warning Limit " + num2 + " reached, the next is BAN");
                                }
                                else if (num2 > 5)
                                {
                                    serverControll_0.method_23(null, entity_0, 3, "TempBan 5min - Warning Limit " + num2 + " reached!");
                                }
                            }
                            else
                            {
                        ...
                        if (!flag)
                        {
                            ...
                            smethod_64(serverControll_0, "^5" + serverControll_0.getPlayerName(entity_0) + " ^7WARN nr[^11^7] -^5 " + string_1);
                        }
                        writer.Close();
                        return;
                    }
                ...
                if (string_0 == "del")
                {
                    ...
                    using (writer = new StreamWriter(ServerControll.string_84 + ServerControll.string_52, true))
                    {
                        ...
                        if (flag)
                        {
                            smethod_73(serverControll_0, class2.entity_0, "^5Warn of ^1" + serverControll_0.getPlayerName(entity_0) + " ^5deleted");
                        }
                        else
                        {
                            smethod_73(serverControll_0, class2.entity_0, "^1There were no Warn found of ^5" + serverControll_0.getPlayerName(entity_0));
                        }
                        return;
                    }
                }
                if (string_0 == "list")
                {
                    if (System.IO.File.Exists(ServerControll.string_84 + ServerControll.string_52))
                    {
                        ...
                        smethod_73(serverControll_0, class2.entity_0, "^5List^7[^1" + class3.string_0.Length + "^7] ^5Player Warn:");
        ...
        /* private scope */internal static void smethod_26(ServerControll serverControll_0, Entity entity_0)
        {
            if ((!ServerControll.string_93.Contains("inf") && !ServerControll.string_93.Equals("dm")) && !ServerControll.string_93.Equals("oic"))
            {
                ...
                else
                {
                    ...
                    {
                        smethod_73(serverControll_0, entity_0, "^5You can not change teams if you are the last survivor of it");
                    }
                    else
                    {
        ...
        /* private scope */internal static void smethod_3(ServerControll serverControll_0, Entity entity_0)
        {
            ...
            elem5.SetText("^5In Chat:^1 !password");
            elem5.Archived = true;
        ...
        /* private scope */internal static void smethod_39(string string_0, string string_1, ServerControll serverControll_0, Entity entity_0)
        {
            ...
            {
                smethod_158(serverControll_0, entity_0, "^1" + entity_0.Name + " Mode ^5" + string_0.ToUpper() + "^1 not found!");
            }
        }
        ...
        /* private scope */internal static void smethod_45(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                if (System.IO.File.Exists(ServerControll.string_88 + ServerControll.string_57))
                {
                    ...
                    smethod_73(serverControll_0, class2.entity_0, "^5List[^1" + class3.string_0.Length + "^5] Player Last Exit:");
                    serverControll_0.OnInterval(0x3e8, new Func<bool>(class3.method_0));
                }
                else
                {
        ...
        /* private scope */internal static void smethod_46(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_64))
                {
                    ...
                    smethod_73(serverControll_0, class2.entity_0, "^5List[^1" + class3.string_0.Length + "^5] Player Hack:");
        ...
        {
            Utilities.RawSayTo(entity_1, "^7[^5" + serverControll_0.getPlayerName(entity_0) + "^7][^1PM^7]: " + string_0);
        }
        ...
        /* private scope */internal static void smethod_52(ServerControll serverControll_0, Entity entity_0)
        {
            if (((((entity_0.GetField<string>("sessionteam") == "axis") && (serverControll_0.getPlayerAccess(entity_0) != 1)) && (serverControll_0.Call<int>("getteamplayersalive", new Parameter[] { "allies" }) > 0)) && (smethod_95(serverControll_0) > 0x2710)) && (serverControll_0.getPlayerTmpINF(entity_0) != "null"))
            {
                ...
                {
                    serverControll_0.method_23(null, entity_0, ServerControll.int_30, "^1Tempban for RageQuit Infect for ^5" + ServerControll.int_30 + "min");
                    smethod_64(serverControll_0, string.Concat(new object[] { serverControll_0.getPlayerName(entity_0), " - ^1Tempban for RageQuit Infect for ^5", ServerControll.int_30, "min" }));
                }
            }
        }
        ...
        /* private scope */internal static void smethod_54(ServerControll serverControll_0)
        {
            ...
            if (ServerControll.bool_30)
            {
                ...
                parser.SaveSettings();
                smethod_64(serverControll_0, "^51Shot 1Kill Disabled");
            }
            else
            {
                ...
                parser.SaveSettings();
                smethod_64(serverControll_0, "^11Shot 1Kill Enabled");
            }
        }
        ...
        /* private scope */internal static void smethod_61(int int_0, Entity entity_0, Entity entity_1, string string_0, ServerControll serverControll_0)
        {
            try
            {
                if (string_0 == "add")
                {
                    ...
                    smethod_64(serverControll_0, "^1" + serverControll_0.getPlayerName(entity_0) + " ^5 added to the group of^1 " + ServerControll.DBNomeGruppi[int_0]);
                    ...
                    for (int i = 0; i < ServerControll.DBPlayerlvl.Count; i++)
                    {
                        ...
                        for (int j = 0; j < strArray.Length; j++)
                        {
                            ...
                            else
                            {
                                smethod_203(0, serverControll_0, entity_0);
                                smethod_182(0, entity_0, serverControll_0);
                                smethod_64(serverControll_0, "^1" + serverControll_0.getPlayerName(entity_0) + " ^5 deleted from the group of^1 " + ServerControll.DBNomeGruppi[i]);
                            }
                        }
                        str2 = str2.TrimStart(new char[] { ServerControll.char_1 });
        ...
        /* private scope */internal static void smethod_63(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                ...
                smethod_73(serverControll_0, class3.entity_0, "^5All Player[^1" + ServerControll.list_2.Count + "^5] List in Game:");
                class2.int_0 = 0;
        ...
        /* private scope */internal static void smethod_69(Entity entity_0, ServerControll serverControll_0)
        {
            try
            {
                ...
                {
                    Utilities.RawSayAll(ServerControll.string_4 + "^7: " + entity_0.Name + " ^5Connecting...");
                }
            }
            catch (Exception exception)
            {
        ...
        {
            Utilities.RawSayTo(entity_0, ServerControll.string_4 + "^7[PM]: " + string_0);
        }
        ...
        /* private scope */internal static void smethod_75(ServerControll serverControll_0, Entity entity_0, string string_0)
        {
            try
            {
                ...
                if ((strArray[0] == "!votekick") || (strArray[0] == "!voteban"))
                {
                    ...
                    {
                        smethod_73(serverControll_0, entity_0, "^5Player not found? Use^1 ID");
                ...
                else if (strArray[0] == "!votemod")
                {
                    ...
                    {
                        smethod_158(serverControll_0, entity_0, "^1" + entity_0.Name + " Mode ^5" + strArray[1].ToUpper() + "^1 not found!");
                    }
                }
            }
            catch (Exception exception)
        ...
        /* private scope */internal static void smethod_77(Entity entity_0, ServerControll serverControll_0, Entity entity_1)
        {
            if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_56))
            {
                ...
                Label_00BC:
                    flag = true;
                    string str2 = string.Empty;
                    smethod_73(serverControll_0, entity_1, "^5Player: ^1" + serverControll_0.getPlayerName(entity_0) + " ^5also known as:");
                ...
                Label_013E:
                    if (!flag)
                    {
                        smethod_73(serverControll_0, entity_1, "^5Player ^1" + serverControll_0.getPlayerName(entity_0) + " ^5not use alias");
                    }
                }
            }
        }
        ...
        /* private scope */internal static void smethod_85(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            smethod_73(serverControll_0, entity_0, "^5Private game or training in progress, if you are not allowed go out... tnx");
        }
        ...
        /* private scope */internal static void smethod_86(Entity entity_0, ServerControll serverControll_0)
        {
            ...
            try
            {
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_55))
                {
                    ...
                    smethod_73(serverControll_0, class2.entity_0, "^5List[^1" + class3.string_0.Length + "^5] Player Ban:");
                    serverControll_0.OnInterval(900, new Func<bool>(class3.method_0));
                }
                else
                {
        ...
        /* private scope */internal static void smethod_87(ServerControll serverControll_0, Entity entity_0)
        {
            if (entity_0.HasField("DioInTerra"))
            {
                ...
                {
                    smethod_158(serverControll_0, entity_0, "^5" + serverControll_0.getPlayerName(entity_0) + " ^1GodMode disabled!!!");
                    entity_0.SetField("DioInTerra", 0);
                }
                else if (entity_0.GetField<int>("DioInTerra") == 0)
                {
                    smethod_158(serverControll_0, entity_0, "^5" + serverControll_0.getPlayerName(entity_0) + " ^1GodMode enabled!!!");
        ...
        internal static void smethod_9(Entity entity_0, string string_0, ServerControll serverControll_0)
        {
            ...
            elem2.Call("settext", new Parameter[] { "Press^1 [{+actionslot 7}] ^7to go down,^1 [{+actionslot 6}] ^7to go up and^1 [{toggleprone}] ^7to select action for ^5" + string_0 });
            elem2.Alpha = 0f;
        ...
        internal static void smethod_96(string string_0, ServerControll serverControll_0, string string_1, Entity entity_0)
        {
            ...
            if (string_0 == "add")
            {
                using (writer = new StreamWriter(ServerControll.string_85 + ServerControll.string_51, true))
                {
                    ...
                    if (entity_0 != null)
                    {
                        smethod_73(serverControll_0, entity_0, "^1" + string_1 + "^5 added to the BadWords list!");
                    }
                    return;
                }
            }
                ...
                if (System.IO.File.Exists(ServerControll.string_85 + ServerControll.string_51))
                {
                    ...
                    for (int i = 0; i < strArray.Length; i++)
                    {
                        ...
                        if (strArray[i].ToLower().Contains(string_1))
                        {
                            ...
                            smethod_73(serverControll_0, entity_0, "^5Word ^1" + strArray[i] + "^5 found and eliminated!");
                        }
                        if (flag2)
                        {
                            using (writer = new StreamWriter(ServerControll.string_85 + ServerControll.string_51, true))
