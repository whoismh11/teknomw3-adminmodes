namespace ServerControll
{
    ...
    public class ServerControll : BaseScript
    {
        ...
        public static string AFKMessages = "^1<playername>^7 Is AFK Or Is A Camper!";
        ...
        public static bool AntiBadWords = true;
        ...
        public static string BanMess = "^1<playername>^7 Has Been Banned For ^5<reason>^7 By ^2<kicker>^7!";
        ...
        public static int ColorAdmin = 2;
        public static int ColorMod = 2;
        public static bool ColorNickAdmin = true;
        public static bool ColorNickTeam = false;
        public static int ColorSeniorMod = 2;
        public static int ColorSuperAdmin = 2;
        ...
        public static bool ControllGrafica = true;
        public static bool ControllNick = true;
        public static bool CtrBots = false;
        public static Process currentProcess = Process.GetCurrentProcess();
        /*public static string DeadExplosiveMess = "^1<playerdead>^7 Blown Up!";
        public static string DeadFailMoabMess = "^2<playerattack>^7 MOAB-FAIL Hahahaha!";
        public static string DeadFallingMess = "^1<playerdead>^7 Is Spider Man!";
        public static string DeadHeadShotMess = "^1<playerdead>^7 HeadShot By ^2<playerattack>^7!";
        public static string DeadMeleeMess = "^1<playerdead>^7 Troll By ^2<playerattack>^7!";
        public static bool DeadMessages = false;
        public static string DeadMoabMess = "^2<playerattack>^7 MultiKill With MOAB!!!";*/
        ...
        public static string FileAdm = "NaaBAdmin";
        ...
        //public static string FileGPSWeb = "https://naabclub.ir";
        public static string FileLastExit = "LastExit";
        public static string FileLoginAdmin = "AdminLogin";
        public static string FileMatch = "CurrentClients";
        ...
        public static string FileWarn = "Warns.txt";
        ...
        public static bool HightFPS = true;
        public static string InfoBan = "TS.NaaBClub.IR";
        ...
        public static string KickMess = "^1<playername>^7 Has Been Kicked For ^5<reason>^7 By ^2<kicker>^7!";
        ...
        public static string Piattaforma = "plusmw3";
        ...
        public static bool StatVotazione = true;
        ...
        public static string TeamA = "Allies";
        public static string TeamAInfect = "SURVIVORS";
        public static string TeamB = "Axis";
        public static string TeamBInfect = "INFECTED";
        public static string TeamIconAllies = "null";
        public static string TeamIconAxis = "null";
        public static string TeamIconInfAllies = "null";
        public static string TeamIconInfAxis = "null";
        public static string TeampbanMess = "^1<playername>^7 Has Been TempBanned For ^5<reason> ^7By ^2<kicker>^7!";
        ...
        public static string TitleClan = "WWW.NaaBClub.IR";
        ...
        public static string WelcomeAdminMess = "^2<playername> ^7Welcome To";
        public static bool WelcomeMessages = true;
        public static string WelcomeModMess = "^2<playername> ^7Welcome To";
        public static string WelcomeSeniorModMess = "^2<playername> ^7Welcome To";
        public static string WelcomeSuperAdminMess = "^2<playername> ^7Welcome To";
        public static string WelcomeUserMess = "^2<playername> ^7Welcome To";
        public static string WelcomeToMess = "^2<nameclan> ^7Server!";
        public static int xlrDay = 7;
        public static bool XLRonInfect = false;
        public static bool XlrStatsEnable = true;
        public static string xStrComandiA = "!minefield,!maprotate,!listall,!setpw,!password,!editpass,!showpass,!statuspass,!night,!ban,!b,!unban,!ub,!ban2,!bot,!kb,!loadbots,!b2,!kill,!voting,!chat,!changeteam,!endround,!fire,!eb,!banexit,!be,!kickall,!ka";
        ...
        public ServerControll()
        {
            ...
            AfterDelay(100, () =>
            {
                if (File.Exists(@"scripts\NaaBAdmin\AutoVoteMap.txt"))
                {
                    File.Delete("scripts\\NaaBAdmin\\AutoVoteMap.txt");
                }
            });
            AfterDelay(1000, () =>
                       {
                           ...
                           if (finalResult == 0)
                           {
                               Call("iprintlnbold", new Parameter[] { "^5scr_" + CurrentGametype + "_scorelimit" + " ^7AutoVote Disabled!" });
                               return;
                           }
                           if (!File.Exists(@"scripts\NaaBAdmin\AutoVoteMap.txt"))
                           {
                               using (StreamWriter txt_write = File.AppendText(@"scripts\NaaBAdmin\AutoVoteMap.txt"))
                               {
                                   txt_write.Write("timelimit=" + tlimit + Environment.NewLine);
                               };
                           };
                           string[] lines = System.IO.File.ReadAllLines("scripts\\NaaBAdmin\\AutoVoteMap.txt");
                           foreach (string line in lines)
                           {
                               if (line.StartsWith("timelimit"))
                               {
                                   _switchTime = Convert.ToInt32(line.Split('=')[1]);
                                   //Call("iprintlnbold", new Parameter[] {"^7TimeLimit: ^5(^7" + "_switchTime + ^5)"});
                               }
                           }
                           AfterDelay(78000, () =>
                           {
                               OnInterval(60000, () =>
                               {
                                   ...
                                   if (_switchTime <= 1)
                                   {
                                       // Call("iprintlnbold", new Parameter[] { "^7Vote started: ^5(^7" + _switchTime + "^5)"});
            ...
            if (roll.HasValue)
            {
                switch (valueOrDefault)
                {
                    case 0:
                        ...
                        Utilities.RawSayAll("^7Server Has Requested a Vote");
                        ...
                        ServerControll.TitleVote.SetText("^7Vote Change Map ^5" + Class67.smethod_124(this, sMessage[1]) + "^7?");
                        ...
                        OnInterval(1000, delegate
                        {
                            ...
                            ServerControll.TitleVote2.SetText(string.Concat(new object[] { "^5!y ^7Or ^5!n ^7- [^5", ServerControll.VotoSi, "^7/^5", ServerControll.VotoNo, "^7] Conclusion ^5", vote.time, "^7s" }));
                            vote.time -= 1;
                            if (vote.time <= 3)
                            {
                                foreach (Entity plAyer in Players)
                            ...
                            if (vote.time == 0)
                            {
                                ...
                                if (num2 <= num)
                                {
                                    Utilities.RawSayAll(ServerControll.BotName + "^7: ^1" + "Negative Vote ^7- Voters Must Exceed Half Of Online Gamers!");
                                    return false;
                                }
                                if (ServerControll.VotoSi > ServerControll.VotoNo)
                                {
                                    Utilities.RawSayAll(ServerControll.BotName + "^7: ^2" + "Positive Vote");
                                    AfterDelay(4000, () =>
                                   {
                                ...
                                {
                                    Utilities.RawSayAll(ServerControll.BotName + "^7: ^1" + "Negative Vote");
                                };
                            }
                            return true;
                        });
                    ...
                    case 1:
                        ...
                        ServerControll.TitleVote2.SetPoint("TOPLEFT", "TOPLEFT", 10, 120);
                        ServerControll.TitleVote2.HideWhenInMenu = true;
                        ServerControll.TitleVote.SetText("^7Vote Change Map ^5" + Class67.smethod_124(this, sMessage2[1]) + "^7?");
                        ServerControll.TitleVote.Alpha = 1f;
                        ServerControll.TitleVote2.Alpha = 1f;
                    ...
                    case 2:
                        ...
                        ServerControll.TitleVote2.SetPoint("TOPLEFT", "TOPLEFT", 10, 120);
                        ServerControll.TitleVote2.HideWhenInMenu = true;
                        ServerControll.TitleVote.SetText("^7Vote Change Map ^5" + Class67.smethod_124(this, sMessage3[1]) + "^7?");
                        ServerControll.TitleVote.Alpha = 1f;
                        ServerControll.TitleVote2.Alpha = 1f;
                    ...
                    case 3:
                        ...
                        ServerControll.TitleVote2.SetPoint("TOPLEFT", "TOPLEFT", 10, 120);
                        ServerControll.TitleVote2.HideWhenInMenu = true;
                        ServerControll.TitleVote.SetText("^7Vote Change Map ^5" + Class67.smethod_124(this, sMessage4[1]) + "^7?");
                        ServerControll.TitleVote.Alpha = 1f;
                        ServerControll.TitleVote2.Alpha = 1f;
        ...
        public void Dio(Entity player)
        {
            if (player.HasField("DioInTerra"))
            {
                ...
                {
                    player.Call("iprintlnbold", new Parameter[] { "^1" + this.getPlayerName(player) + " ^7GodMode Disabled!!!" });
                    player.SetField("DioInTerra", 0);
                }
                else if (player.GetField<int>("DioInTerra") == 0)
                {
                    player.Call("iprintlnbold", new Parameter[] { "^2" + this.getPlayerName(player) + " ^7GodMode Enabled!!!" });
                                                    ...
                                                    if (strArray[0] != "!invisiblegod")
                                                    {
                                                        if (strArray[0] != "!fire")
                                                        {
                                                            if (strArray[0] != "!svname")
                                                            {
                                                                ...
                                                                else if (strArray[0] != "!setafk")
                                                                {
                                                                    if (strArray[0] == "!afk")
                                                                    {
                                                                        if (!TypeMap.Contains("inf"))
                                                                        {
                                                                            ...
                                                                            Class67.smethod_125(this, class2.entity_0, "^1" + class2.entity_0.Name + " ^7Set AFK");
                                                                        }
                                                                        else
                                                                        {
                                                                    ...
                                                                    else if (strArray[0] == "!endround")
                                                                    {
                                                                        ...
                                                                        Class67.smethod_101(this, "^7Round Ended By: ^2" + class2.entity_0.Name);
                                                                    }
                                                                        ...
                                                                        else if (strArray[0] != "!info")
                                                                        {
                                                                            ...
                                                                            else if (strArray[0] != "!bot")
                                                                            {
                                                                                if (strArray[0] != "!setclient")
                                                                                {
                                                                                    if (strArray[0] != "!downgrade")
                                                                                    {
                                                                                        ...
                                                                                        else if (strArray[0] == "!load")
                                                                                        {
                                                                                            if (strArray.Length < 2)
                                                                                            {
                                                                                                Class67.smethod_125(this, class2.entity_0, "^7Enter The Name Of The Script. Example: ^5!load NaaBAdmin.dll");
                                                                                            }
                                                                                        ...
                                                                                        else if (strArray[0] == "!unload")
                                                                                        {
                                                                                            if (strArray.Length < 2)
                                                                                            {
                                                                                                Class67.smethod_125(this, class2.entity_0, "^7Enter The Name Of The Script. Example: ^5!unload NaaBAdmin.dll");
                                                                                            }
                                                                                            else if (!System.IO.File.Exists(@"scripts\" + strArray[1]))
                                                                                            {
                                                                                                Class67.smethod_125(this, class2.entity_0, "^7File Script Not Found!");
                                                                                        ...
                                                                                        else if (strArray[0] != "!j")
                                                                                        {
                                                                                            if (strArray[0] != "!s")
                                                                                            {
                                                                                                            ...
                                                                                                            if (strArray[0] != "!addadv")
                                                                                                            {
                                                                                                                if (strArray[0] != "!addrules")
                                                                                                                {
                                                                                                                    ...
                                                                                                                    else if (strArray[0] == "!setpw")
                                                                                                                    {
                                                                                                                        if (strArray.Length != 1)
                                                                                                                        {
                                                                                                                            if (strArray[1] == "null")
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                class2.entity_0.Call("iprintlnbold", new Parameter[] { "^1" + this.getPlayerName(class2.entity_0) + " ^7Password DeActivated!" });
                                                                                                                            }
                                                                                                                            else
                                                                                                                            {
                                                                                                                                this.CommandConsole("g_password " + strArray[1], 0);
                                                                                                                                class2.entity_0.Call("iprintlnbold", new Parameter[] { "^2" + this.getPlayerName(class2.entity_0) + " ^7Password Activated!" });
                                                                                                                            }
                                                                                                                        }
                                                                                                                        else
                                                                                                                        {
                                                                                                                    ...
                                                                                                                    else if (strArray[0] == "!night")
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        class2.entity_0.Call("iprintlnbold", new Parameter[] { string.Concat(new object[] { "^2", this.getPlayerName(class2.entity_0), " ^7Night Set ^5", Oscuro }) });
                                                                                                                    }
                                                                                                                    else if (strArray[0] != "!kill")
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        {
                                                                                                                            base.Call("iprintln", new Parameter[] { "^7Current Atmosphere Parameters:" });
                                                                                                                            base.Call("iprintln", new Parameter[] { string.Concat(new object[] { "^7Jump: ^5", JumpHeight, "^7 - Speed: ^5", Speed, "^7 - Gravity: ^5", Gravity }) });
                                                                                                                                ...
                                                                                                                                if ((strArray.Length > 2) && Class67.smethod_91(strArray[2]))
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    if (entity33 != null)
                                                                                                                                    {
                                                                                                                                        if (this.getPlayerLevel(entity33) < this.getPlayerLevel(class2.entity_0))
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            {
                                                                                                                                                this.method_15(class2.entity_0, entity33, int.Parse(strArray[2]), "^7TempBan For: ^5" + int.Parse(strArray[2]) + "^7Min!");
                                                                                                                                            }
                                                                                                                                        }
                                                                                                                                        ...
                                                                                                                                        if (strArray[0] != "!tempbanlist")
                                                                                                                                        {
                                                                                                                                            if (strArray[0] != "!mute")
                                                                                                                                            {
                                                                                                                                                                        ...
                                                                                                                                                                        else if (strArray[0] != "!setnextmap")
                                                                                                                                                                        {
                                                                                                                                                                            ...
                                                                                                                                                                            else if (strArray[0] == "!resetfog")
                                                                                                                                                                            {
                                                                                                                                                                                foreach (Entity entity42 in Giocatori)
                                                                                                                                                                                {
                                                                                                                                                                                    ...
                                                                                                                                                                                    entity42.SetClientDvar("r_fog", "1");
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (strArray[0] != "!spam")
                                                                                                                                                                                    {
                                                                                                                                                                                        if (strArray[0] != "!pm")
                                                                                                                                                                                        {
                                                                                                                                                                                            ...
                                                                                                                                                                                            else if (strArray[0] != "!suicide")
                                                                                                                                                                                            {
                                                                                                                                                                                                ...
                                                                                                                                                                                                {
                                                                                                                                                                                                    Class67.smethod_125(this, class2.entity_0, string.Concat(new object[] { "^7It's ^5", DateTime.Now.ToShortTimeString(), "^7 O'clock Of ^5", DateTime.Now.Day, "^7/^5", DateTime.Now.Month, "^7/^5", DateTime.Now.Year }));
                                                                                                                                                                                                }
                                                                                                                                                                                                ...
                                                                                                                                                                                                else if (strArray[0] != "!team")
                                                                                                                                                                                                {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    {
                                                                                                                                                                                                        Class67.smethod_125(this, class2.entity_0, "^7NaaBAdmin v4.1 By ^5MH11");
                                                                                                                                                                                                    }
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if (strArray.Length != 1)
                                                                                                                                                                                                        {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            else if (!strArray[0].Contains("map"))
                                                                                                                                                                                                            {
                                                                                                                                                                                                                if (strArray[0].Contains("mod"))
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    {
                                                                                                                                                                                                                        class2.entity_0.Call("iprintlnbold", new Parameter[] { "^2" + class2.entity_0.Name + " ^7Mod ^5" + strArray[1].ToUpper() + "^7 Not Found!" });
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                }
                                                                                                                                                                                                            }
                                                                                                                                                                                                            else
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    else if (strArray[0] == "!access")
                                                                                                                                                                                                    {
                                                                                                                                                                                                        if (strArray.Length != 1)
                                                                                                                                                                                                        {
                                                                                                                                                                                                            if ((strArray[1] == PassManualLogin) && (this.getPlayerLevel(class2.entity_0) == 1))
                                                                                                                                                                                                            {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                Class67.smethod_101(this, "^2" + this.getPlayerName(class2.entity_0) + " ^7Manual Login As Owner");
                                                                                                                                                                                                            }
                                                                                                                                                                                                            else
                                                                                                                                                                                                            {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    else if (strArray[0] == "!login")
                                                                                                                                                                                                    {
                                                                                                                                                                                                        if (strArray.Length != 1)
                                                                                                                                                                                                        {
                                                                                                                                                                                                            if (((strArray[1] == PassLoginAdmin) && (this.getPlayerLevel(class2.entity_0) > 1)) && (this.getPlayerAccess(class2.entity_0) == 0))
                                                                                                                                                                                                            {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                Class67.smethod_125(this, class2.entity_0, "^2" + this.getPlayerName(class2.entity_0) + " ^7Control Enabled!");
                                                                                                                                                                                                            }
                                                                                                                                                                                                            else
                                                                                                                                                                                                            {
                                                                                                                                                                                                                Class67.smethod_125(this, class2.entity_0, "^7Wrong Password Or You're Graduated!");
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    else if (strArray[0] == "!iamgod")
                                                                                                                                                                                                    {
                                                                                                                                                                                                        if (((StrSuperAdmin.Length == 0) && (StrAdmin.Length == 0)) && ((StrSeniorMod.Length == 0) && (StrMod.Length == 0)))
                                                                                                                                                                                                        {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            Class67.smethod_125(this, class2.entity_0, "^2" + this.getPlayerName(class2.entity_0) + " ^7Registered As Owner");
                                                                                                                                                                                                        }
                                                                                                                                                                                                        else
                                                                                                                                                                                                        {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    else if (strArray[0] == "!xlrstats")
                                                                                                                                                                                                    {
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        else
                                                                                                                                                                                                        {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if (strArray.Length == 1)
                                                                                                                                                                                                            {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if (strArray4 != null)
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    Class67.smethod_125(this, class2.entity_0, "^7Your Stats: Kill ^5" + strArray4[3].ToString() + "^7, Dead ^5" + strArray4[4].ToString() + "^7, Skill ^5" + strArray4[5].ToString());
                                                                                                                                                                                                                }
                                                                                                                                                                                                                else
                                                                                                                                                                                                                {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            else
                                                                                                                                                                                                            {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if (entity47 != null)
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if (strArray4 != null)
                                                                                                                                                                                                                    {
                                                                                                                                                                                                                        Class67.smethod_125(this, class2.entity_0, "^7Player^5 " + this.getPlayerName(entity47) + " ^7Stats: Kill ^5" + strArray4[3].ToString() + "^7, Dead ^5" + strArray4[4].ToString() + "^7, Skill ^5" + strArray4[5].ToString());
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                    else
                                                                                                                                                                                                                    {
                                                                                                                                                                                        ...
                                                                                                                                                                                        else if (strArray.Length > 2)
                                                                                                                                                                                        {
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (entity43 != null)
                                                                                                                                                                                            {
                                                                                                                                                                                                ...
                                                                                                                                                                                                Class67.smethod_125(this, class2.entity_0, "^7Mess Sent To ^2" + this.getPlayerName(entity43));
                                                                                                                                                                                            }
                                                                                                                                                                                        }
                                                                                                                                                                                    }
                                                                                                                                                                                    else if (strArray.Length != 1)
                                                                                                                                                ...
                                                                                                                                                else if (strArray.Length == 2)
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    if (entity36 != null)
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        Class67.smethod_125(this, class2.entity_0, "^2" + this.getPlayerName(entity36) + " ^7UnMuted!");
                                                                                                                                                    }
                                                                                                                                                }
                                                                                                                                            }
                                                                                                                                            else if (strArray.Length == 2)
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                if (entity35 != null)
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    Class67.smethod_125(this, class2.entity_0, "^1" + this.getPlayerName(entity35) + " ^7Muted!");
                                                                                                                                                }
                                                                                                                                            }
                                                                                                                                        }
                                                                                                                                        else if (strArray.Length == 1)
                                                                                                                    ...
                                                                                                                    else if (strArray.Length != 1)
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        if ((entity31 != null) && entity31.IsAlive)
                                                                                                                        {
                                                                                                                            if (this.getPlayerLevel(entity31) <= this.getPlayerLevel(class2.entity_0))
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                Class67.smethod_125(this, class2.entity_0, "^1" + this.getPlayerName(entity31) + " ^7Killed!");
                                                                                                                            }
                                                                                                                            else
                                                                                                                            {
                                                                                                ...
                                                                                                else if ((strArray.Length != 1) && Class67.smethod_91(strArray[1]))
                                                                                                {
                                                                                                    ...
                                                                                                    base.Call("iprintln", new Parameter[] { string.Concat(new object[] { "^2", this.getPlayerName(class2.entity_0), " ^7Gravity: ^5", Gravity, " ^7-------> ^5", int_1 }) });
                                                                                                    Gravity = int_1;
                                                                                                }
                                                                                            }
                                                                                            else if ((strArray.Length != 1) && Class67.smethod_91(strArray[1]))
                                                                                            {
                                                                                                ...
                                                                                                base.Call("iprintln", new Parameter[] { string.Concat(new object[] { "^2", this.getPlayerName(class2.entity_0), " ^7Speed: ^5", Speed, " ^7-------> ^5", int_0 }) });
                                                                                                Speed = int_0;
                                                                                            }
                                                                                        }
                                                                                        else if ((strArray.Length != 1) && Class67.smethod_91(strArray[1]))
                                                                                        {
                                                                                            ...
                                                                                            base.Call("iprintln", new Parameter[] { string.Concat(new object[] { "^2", this.getPlayerName(class2.entity_0), " ^7Jump: ^5", JumpHeight, " ^7-------> ^5", salto }) });
                                                                                            JumpHeight = salto;
                                                                                        }
                                                                                    }
                                                                                    else if (strArray.Length != 1)
                                                                                    {
                                                                                        ...
                                                                                        if (entity24 != null)
                                                                                        {
                                                                                            ...
                                                                                            class2.entity_0.Call("iprintlnbold", new Parameter[] { "^7Degraded ^1" + this.getPlayerName(entity24) });
                                                                                        }
                                                                                    }
                                                                                }
                                                                                else if (strArray.Length > 2)
                                                                                {
                                                                                    ...
                                                                                    class2.entity_0.Call("iprintlnbold", new Parameter[] { "^2" + this.getPlayerName(class2.entity_0) + " ^7Set Parameters!" });
                                                                                }
                                                                            }
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        if (entity21 != null)
                                                                        {
                                                                            ...
                                                                            class2.entity_0.Call("iprintlnbold", new Parameter[] { "^7FilmTweak Set a ^2" + entity21.Name });
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                else if (strArray.Length != 1)
                                                                {
                                                                    ...
                                                                    if (entity20 != null)
                                                                    {
                                                                        ...
                                                                        Class67.smethod_125(this, class2.entity_0, "^1" + entity20.Name + " ^7Set AFK");
                                                                    }
                                                                }
                                                            }
                                                            else if (strArray.Length != 1)
                                                            {
                                                                ...
                                                                Class67.smethod_125(this, class2.entity_0, "^7Server Name Set To: " + str7.Trim());
                                                            }
                                                        }
                                                        else if (strArray.Length != 1)
                                                        {
            ...
            if (System.IO.File.Exists(DirTempFile + FileLastExit))
            {
                ...
                Label_0079:
                    ...
                    using (StreamWriter writer = new StreamWriter(DirConfMove + FileTempBan, true))
                    {
                        ...
                        writer.Close();
                        Class67.smethod_101(this, string.Concat(new object[] { "^7Player ^1", strArray2[0], " ^7TempBanned For ^5", int_3, "^7Min!" }));
                    }
                Label_0139:
                    if (flag)
                    {
        ...
        private void method_1(Entity entity_0, string string_1, int int_3)
        {
            if (System.IO.File.Exists(DirTempFile + FileLastExit))
            {
                ...
                Label_0097:
                    ...
                    Class67.smethod_125(this, entity_0, "^7Player ^1" + strArray2[0] + "^5[^7" + strArray2[1] + "^5] ^7Successfully TempBanned!");
                Label_0155:
                    if (flag)
                    {
                        break;
        ...
        private void method_11(Entity entity_0, string string_1)
        {
            foreach (Entity entity in Giocatori)
            {
                if (this.getPlayerLevel(entity) > 1)
                {
                    ...
                    {
                        Utilities.RawSayTo(entity, "^7" + BotName + " For Member^5[^7PM^5]:^7 " + string_1);
                    }
                }
            }
        }
        ...
        private void method_12(Entity entity_0, Entity entity_1)
        {
            if (System.IO.File.Exists(DirConfMove + FileAlias))
            {
                ...
                Label_00AB:
                    flag = true;
                    Class67.smethod_125(this, entity_0, "^7Player: ^2" + this.getPlayerName(entity_1) + " ^7Also Known As:");
                    Class67.smethod_125(this, entity_0, "^1" + strArray[i].Replace(sep1.ToString(), "^5<>^7"));
                Label_00F3:
                    if (!flag)
                    {
        ...
        internal void method_15(Entity entity_0, Entity entity_1, int int_3, string string_1)
        {
            using (StreamWriter writer = new StreamWriter(DirConfMove + FileTempBan, true))
            {
                ...
                if (entity_0 != null)
                {
                    Class67.smethod_125(this, entity_0, string.Concat(new object[] { "^1", this.getPlayerName(entity_1), " ^7Added To The TempBan List For ^5", int_3, "^7Min" }));
        ...
        private void method_16(Entity entity_0, string string_1)
        {
            if (System.IO.File.Exists(DirConfMove + FileTempBan))
            {
                ...
                Label_00AA:
                    flag2 = false;
                    flag = true;
                    Class67.smethod_125(this, entity_0, "^7Player ^2" + strArray2[0] + "^5[^7" + strArray2[1] + "^5] ^7Successfully UnBanned!");
                    goto Label_0134;
                Label_00F0:
                    flag2 = false;
                    flag = true;
                    Class67.smethod_125(this, entity_0, "^7Player ^2" + strArray2[1] + "^5[^7" + strArray2[2] + "^5] ^7Successfully UnBanned!");
                Label_0134:
                    if (flag2)
                    {
                        using (StreamWriter writer = new StreamWriter(DirConfMove + FileTempBan, true))
        ...
        internal void method_17(Entity entity_0, Entity entity_1, string string_1)
        {
            using (StreamWriter writer = new StreamWriter(DirConfMove + FilePermBan, true))
            {
                ...
                if (entity_0 != null)
                {
                    Class67.smethod_125(this, entity_0, "^1" + this.getPlayerName(entity_1) + " ^7Added To The PermBan List!");
        ...
        private void method_19(Entity entity_0, string string_1, string string_2)
        {
            if (string_2 == "add")
            {
                ...
                using (StreamWriter writer = new StreamWriter(DirConfMove + FileReports, true))
                {
                    ...
                    if (entity_0 != null)
                    {
                        Class67.smethod_125(this, entity_0, "^1" + this.getPlayerName(player) + " ^7Added To The Player Hack List!");
                    }
                    return;
                }
            }
            if (string_2 == "del")
            {
                if (System.IO.File.Exists(DirConfMove + FileReports))
                {
                    ...
                    Label_0216:
                        flag2 = false;
                        flag = true;
                        Class67.smethod_125(this, entity_0, "^7Report Player ^2" + strArray2[0] + "^5[^7" + strArray2[1] + "^5] ^7Successfully Deleted!");
                    Label_025D:
                        if (flag2)
                        {
        ...
        private void method_2(Entity entity_0, string string_1)
        {
            if (System.IO.File.Exists(DirTempFile + FileLastExit))
            {
                ...
                Label_0097:
                    ...
                    Class67.smethod_125(this, entity_0, "^7Player ^1" + strArray2[0] + "^5[^7" + strArray2[1] + "^5] ^7Successfully Banned!");
                Label_0127:
                    if (flag)
                    {
                        break;
        ...
        private void method_25(Entity entity_0, string string_1, Entity entity_1, string string_2)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Class67.smethod_101(this, "^2" + this.getPlayerName(class4.entity_0) + " ^7Has Requested a Vote");
        ...
        internal bool method_43()
        {
            if (Giocatori.Count > 0)
            {
                ...
                {
                    case 0:
                        if (!this.SuperAdminOnline().Contains("^7-----") && ShowLoginAdmin)
                        {
                    ...
                    case 1:
                        if (!this.AdminOnline().Contains("^7-----") && ShowLoginAdmin)
                        {
                    ...
                    case 2:
                        if (!this.SeniorModOnline().Contains("^7-----") && ShowLoginAdmin)
                        {
                    ...
                    case 3:
                        if (!this.ModOnline().Contains("^7-----") && ShowLoginAdmin)
                        {
                    ...
                    foreach (Entity entity in Giocatori)
                    {
                        ...
                        if (this.Names.ContainsKey(str))
                        {
                            if (this.Names[str] != this.getPlayerName(entity))
                            {
                                ...
                                Class67.smethod_101(this, "^2" + this.Names[str] + " ^7ID ^5" + this.getPlayerID(entity) + " ^7Changed Nick: ^1" + this.getPlayerName(entity));
            ...
            foreach (string Cmd in ImmunityCommands)
            {
                ...
                try
                {
                    ...
                    if (message.StartsWith("!"))
                    {
                        ...
                        if ((strArray[0] == ("!" + PasswordAccess)) && this.IsJoinUsers(player))
                        {
                            ...
                            Class67.smethod_125(this, player, "^7ENJOY - BY ^5MH11!!!");
                            return BaseScript.EventEat.EatGame;
                        }
                ...
                Label_032C:
                    ...
                    if (((this.getPlayerLevel(player) < 2) && (type == BaseScript.ChatType.All)) && (this.getPlayerAccess(player) != 1))
                    {
                        ...
                        {
                            player.Call("iprintlnbold", new Parameter[] { "^1" + this.getPlayerName(player) + " ^7You Have Been Muted!" });
                        }
                        return BaseScript.EventEat.EatGame;
                    }
                Label_047E:
            ...
            try
            {
                ...
                using (StreamWriter writer = new StreamWriter(DirConfLocal + FileAdm + ".txt", true))
                {
                    List<string> list = new List<string> {
                        ...
                        "Friend=" + StrMod,
                        "[Function]",
                        "FuncOwner=" + StrComandiSA,
                        "FuncModerator=" + StrComandiA,
                        "FuncMember=" + StrComandiSM,
                        "FuncFriend=" + StrComandiM,
                        "FuncUser=" + StrComandiU,
                        "[Color]",
                        "ColorNickAdmin=" + ColorNickAdmin,
                        "ColorOwner=" + ColorSuperAdmin,
                        "ColorModerator=" + ColorAdmin,
                        "ColorMember=" + ColorSeniorMod,
                        "ColorFriend=" + ColorMod,
                        "[FolderShare]",
                        "Folder=" + DirConfMove
                    };
        ...
        public void Reconfig_Config()
        {
            try
            {
                ...
                {
                    List<string> list = new List<string> {
                        "MasterServer=" + Piattaforma,
                        "AdminLoginPassword=" + PassLoginAdmin,
                        "ManualLoginPassword=" + PassManualLogin,
                        "BotName=" + BotName,
                        "ClanName=" + NomeClan,
                        "ClanTitle=" + TitleClan,
                        "ScorrevoleTitle=" + TitoloScorr,
                        "AlliesTeam=" + TeamA,
                        "AxisTeam=" + TeamB,
                        "InfectSurvivorsTeam=" + TeamAInfect,
                        "InfectInfectedTeam=" + TeamBInfect,
                        "AlliesTeamIcon=" + TeamIconAllies,
                        "AxisTeamIcon=" + TeamIconAxis,
                        "InfectSurvivorsTeamIcon=" + TeamIconInfAllies,
                        "InfectInfectedTeamIcon=" + TeamIconInfAxis,
                        "MaxPing=" + MaxPing,
                        "AdvTime=" + time_adv,
                        "Vote=" + Votazione,
                        "AntiTeamKill=" + AntiTK,
                        "AntiAimbot=" + AntiAIMBOT,
                        "MaxSoundBomb=" + SuonoBomba,
                        "ControlPowers=" + PoteriGraduati,
                        "TeamNamesColor=" + ColorNickTeam,
                        "EditPalyersList=" + EditListPalyer,
                        "InfinityBreath=" + RespiroInfinito,
                        "AntiCookingFrag=" + EsplosioneBomba,
                        "ControlGraphics=" + ControllGrafica,
                        "ControlNames=" + ControllNick,
                        "XlrStats=" + XlrStatsEnable,
                        "AntiCamp=" + AntiCamp,
                        "Jump=" + salto,
                        "Speed=" + int_0,
                        "Gravity=" + int_1,
                        "StatusScriptPassword=" + stato_passSS,
                        "TimeScriptPassword=" + tempo_passSS,
                        "ServerPassword=" + PasswordAccess,
                        "HightFPS=" + HightFPS,
                        "WarnForTeamKill=" + WarnForTeamKill,
                        "WarnForChangeName=" + WarnForChangeNick,
                        "ModCampers=" + ModCampers,
                        "AntiBadWords=" + AntiBadWords,
                        "AutoBalanceTeams=" + Bilanciamento,
                        "GHardCoreSD=" + GHardCore,
                        "FinalKillCam=" + FinalKillCam,
                        //"ScanGPS=" + ScanGPS,
                        "FilmTweak=" + SetFilmTweak,
                        //"AutoUpdate=" + AutoUpdate,
                        "ExplosiveBullets=" + ExplosBull,
                        "AntiNoRecoil=" + AntiNoRecoil,
                        "ShowAdv=" + ShowADV,
                        "XlrOnInfect=" + XLRonInfect,
                        "ShowLoginAdmin=" + ShowLoginAdmin,
                        "Knife=" + knife,
                        "AimbotHeadShotLimit=" + LimitKillTesta,
                        "AimbotOtherLimit=" + LimitKillNormal,
                        "ModAimbot=" + ModAIMBot,
                        "ControlNextMap=" + AutoNextMap,
                        "AntiTeamKillOnlySD=" + AntiTKOnlySD,
                        "ShowRandomRules=" + AutoRules,
                        "VotingTime=" + TempoVoto,
                        "BanInfo=" + InfoBan,
                        "NoSoundADS=" + AntiSoundADS,
                        "Control3Person=" + C3Person
                    };
            ...
            try
            {
                ...
                using (StreamWriter writer = new StreamWriter(DirConfLocal + FileMessages, true))
                {
                    List<string> list = new List<string> {
                        ...
                        "WelcomeUserMessage=" + WelcomeUserMess,
                        "WelcomeFriendsMessage=" + WelcomeModMess,
                        "WelcomeMembersMessage=" + WelcomeSeniorModMess,
                        "WelcomeModeratorsMessage=" + WelcomeAdminMess,
                        "WelcomeOwnersMessage=" + WelcomeSuperAdminMess,
                        /*"DeadMessage=" + DeadMessages,
                        "DeadFallingMessage=" + DeadFallingMess,
                        "DeadMeleeMessage=" + DeadMeleeMess,
                        "DeadHeadShotMessage=" + DeadHeadShotMess,
                        "DeadExplosiveMessage=" + DeadExplosiveMess,*/
                        "KickMessage=" + KickMess,
                        "BanMessage=" + BanMess,
                        "TempBanMessage=" + TeampbanMess,
                        "ControlAFK=" + AntiAFK,
                        "AFKMessage=" + AFKMessages
                    };
                    for (int i = 0; i < list.Count; i++)
                    {
                        writer.WriteLine(list[i]);
            ...
            if (player != player2)
            {
                ...
                else if (cmd.Equals("tempban 60min"))
                {
                    if (Class67.smethod_7("!tb", player, this))
                    {
                        if (this.getPlayerLevel(player2) < this.getPlayerLevel(player))
                        {
                            this.method_15(player, player2, 60, "^7TempBan For ^560^7Min!");
                        }
                        else if (this.getPlayerAccess(player2) == 0)
                        {
                            this.method_15(player, player2, 60, "^7TempBan For ^560^7Min!");
                ...
                else if (cmd.Equals("set afk"))
                {
                    if (Class67.smethod_7("!setafk", player, this))
                    {
                        if (!TypeMap.Contains("inf"))
                        {
                            ...
                            Class67.smethod_125(this, player, "^1" + player2.Name + " ^7Set AFK");
                        }
                        else
                        {
                    ...
                    if (Class67.smethod_7("!kill", player, this))
                    {
                        if (player2.IsAlive)
                        {
                            if (this.getPlayerLevel(player2) <= this.getPlayerLevel(player))
                            {
                                ...
                                Class67.smethod_125(this, player, "^1" + this.getPlayerName(player2) + " ^7killed!");
                            }
                            else
                            {
        ...
        public void ShowRandomAdv()
        {
            if (System.IO.File.Exists(DirConfLocal + FileAdv))
            {
                ...
                if (strArray.Length != 0)
                {
                    ...
                    {
                        Class67.smethod_101(this, string.Concat(new object[] { "^7It's ^5", DateTime.Now.ToShortTimeString(), "^7 O'clock Of ^5", DateTime.Now.Day, "^7/^5", DateTime.Now.Month, "^7/^5", DateTime.Now.Year }));
                    }
        ...
        public void Vola(Entity player)
        {
            if (player.IsAlive)
            {
                if (player.GetField<string>("sessionstate") != "spectator")
                {
                    ...
                    player.Call("iprintlnbold", new Parameter[] { "^2" + this.getPlayerName(player) + " ^7Fly Enabled!!!" });
                }
                else
                {
                    ...
                    player.Call("iprintlnbold", new Parameter[] { "^1" + this.getPlayerName(player) + " ^7Fly Disabled!!!" });
                }
            }
        }
            ...
            try
            {
                    ...
                    using (StreamWriter writer = new StreamWriter(DirConfLocal + FileWarn, true))
                    {
                        for (int i = 0; i < class3.string_0.Length; i++)
                        {
                            ...
                            if (strArray[1] == this.getPlayerGuid(player))
                            {
                                ...
                                Class67.smethod_101(this, string.Concat(new object[] { "^1", this.getPlayerName(player), " ^7WARN NR[^5", num2, "^7] - ^5", testo }));
                                if (num2 == 5)
                                {
                        ...
                        if (!flag)
                        {
                            ...
                            Class67.smethod_101(this, "^1" + this.getPlayerName(player) + " ^7WARN NR[^51^7] - ^5" + testo);
                        }
                        writer.Close();
                        return;
                    }
                ...
                if (tip == "del")
                {
                    ...
                    using (StreamWriter writer2 = new StreamWriter(DirConfLocal + FileWarn, true))
                    {
                        ...
                        if (flag)
                        {
                            Class67.smethod_125(this, class4.entity_0, "^7Warn Of ^2" + this.getPlayerName(player) + " ^7Deleted");
                        }
                        else
                        {
                            Class67.smethod_125(this, class4.entity_0, "^7There Were No Warn Found Of ^2" + this.getPlayerName(player));
                        }
                        return;
                    }
                }
                if (tip == "list")
                {
                    if (System.IO.File.Exists(DirConfLocal + FileWarn))
                    {
                        ...
                        Class67.smethod_125(this, class4.entity_0, "^5List[^7" + class3.string_0.Length + "^5] ^7Player Warn:");
                        base.OnInterval(0x3e8, new Func<bool>(class2.method_0));
                    }
                    else
                    {
        ...
        private sealed class Class12
        {
            ...
            public void method_0()
            {
                Class67.smethod_156(this.serverControll_0, "^2" + this.serverControll_0.getPlayerName(this.entity_0) + " ^7Login Friend For ^5" + ServerControll.NomeClan + " ^7Server");
            }

            public void method_1()
            {
                Class67.smethod_156(this.serverControll_0, "^2" + this.serverControll_0.getPlayerName(this.entity_0) + " ^7Login Member For ^5" + ServerControll.NomeClan + " ^7Server");
            }

            public void method_2()
            {
                Class67.smethod_156(this.serverControll_0, "^2" + this.serverControll_0.getPlayerName(this.entity_0) + " ^7Login Moderator For ^5" + ServerControll.NomeClan + " ^7Server");
            }

            public void method_3()
            {
                Class67.smethod_156(this.serverControll_0, "^2" + this.serverControll_0.getPlayerName(this.entity_0) + " ^7Login Owner For ^5" + ServerControll.NomeClan + " ^7Server");
            }
        }
        ...
        internal sealed class Class15
        {
            ...
            Label_0200:
                ...
                while (num < ServerControll.CharactersNotUsable.Length)
                {
                    ...
                    {
                        Class67.smethod_33(this.serverControll_0, DateTime.Now.ToShortTimeString() + " Expelled " + entity_1.Name + " ^7REASON: Change Your Nick, Characters Not Permitted!^5", new object[0]);
                        this.serverControll_0.CommandConsole("dropclient " + this.entity_0.Call<int>("getentitynumber", new Parameter[0]) + " \"^7Change Your Nick, Characters (^5 , ; = > \x00a7 { } ^7) Not Permitted!\"", 0);
                        return;
                    }
                    num++;
        ...
        internal sealed class Class35
        {
            ...
            public bool method_0()
            {
                ...
                if (span.TotalMinutes < num)
                {
                    ...
                    Class67.smethod_125(this.class34_0.serverControll_0, this.class34_0.entity_0, string.Concat(new object[] { "^7", this.string_1[1], "^5[^7", this.string_1[2], "^5] ^7Banned For Other ^5", num2, "^7Min" }));
                }
                this.int_0++;
                return true;
            }
        ...
        /*internal sealed class Class4
        {
            ...
            public bool method_0()
            {
                foreach (Entity entity in ServerControll.Giocatori)
                {
                    ...
                    {
                        Class67.smethod_125(this.class3_0.serverControll_0, entity, "^7Available To Download The New Version NaaBAdmin ^5" + this.string_1 + " ^7Link: ^5" + this.string_0);
                    }
                }
                Class67.smethod_33(this.class3_0.serverControll_0, "^7Available To Download The New Version NaaBAdmin ^5" + this.string_1 + "\n " + this.string_0, new object[0]);
                return true;
            }
        }*/
        ...
        private sealed class Class48
        {
            ...
            public bool method_0()
            {
                ...
                ServerControll.TitleVote2.SetText(string.Concat(new object[] { "^5!y ^7Or ^5!n ^7- ^5[^7", ServerControll.VotoSi, "/", ServerControll.VotoNo, "^7] Conclusion ^5", this.int_0, "^7s" }));
                return true;
            }
        ...
        private sealed class Class5
        {
            ...
            {
                Class67.smethod_125(this.serverControll_0, entity_1, "^7GPS: Connect From [^5" + this.serverControll_0.lookupIP(this.serverControll_0.GetIPAddress(this.entity_0.EntRef).ToString()) + "^7]");
            }*/
        }
        ...
        private sealed class Class59
        {
            ...
            public bool method_0()
            {
                ...
                this.int_0--;
                Class67.smethod_101(this.serverControll_0, "^7Server Will Be Restarted In ^5" + this.int_0 + "^7s");
                return true;
            }
        }
        ...
        /*private sealed class Class6
        {
            ...
            public void method_0()
            {
                Class67.smethod_101(this.serverControll_0, "^2" + this.string_1 + " ^7Connect From [^5" + this.string_0 + "^7]");
            }
        }*/
