namespace ns5
{
    ...
    internal sealed class Class72
    {
        ...
        private static readonly string string_1 = "48";
        ...
        static Class72()
        {
            ...
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("{64b60c41-e2ec-4c21-9985-7ebe6a2bb17c}"))
            {
                int count = Convert.ToInt32(stream.Length);
                byte[] buffer = new byte[count];
                stream.Read(buffer, 0, count);
                byte_0 = Class67.smethod_54(buffer);
                buffer = null;
                stream.Close();
            }
        }
